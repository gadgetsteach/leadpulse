          ...
          <div class="overview-sidebar-area">
            ...
            <div class="dashboard-card widget-card grow-card">
              ...
              <div class="level-indicator">
                ...
                <a class="btn-text" routerLink="/dashboard/benefits">View Benefits</a>
              </div>
            ...
            <div class="dashboard-card widget-card health-card">
              ...
              <a class="btn-secondary btn-full" routerLink="/dashboard/profile">
            ...
            <div class="dashboard-card widget-card reviews-card">
              ...
              <a class="btn-primary btn-full" routerLink="/dashboard/reviews">
                Get More Reviews
              </a>
            </div>
...
export class DashboardComponent implements OnInit {
  ...
  // Profile data fields synced with standalone Profile component
  ...
  ngOnInit(): void {
    ...
    // Sync profile metrics from localStorage
    const verified = localStorage.getItem('leadpulse_phone_verified');
    if (verified === 'true') {
